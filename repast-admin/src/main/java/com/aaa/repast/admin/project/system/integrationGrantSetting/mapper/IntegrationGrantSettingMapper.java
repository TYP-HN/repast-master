package com.aaa.repast.admin.project.system.integrationGrantSetting.mapper;
 ...
 * @date 2020-01-02
 */
public interface IntegrationGrantSettingMapper 
{
	/**
     * 查询积分发放设置信息
     * 
     ...
     * @return 结果
     */
	public int deleteIntegrationGrantSettingById(Long id);
